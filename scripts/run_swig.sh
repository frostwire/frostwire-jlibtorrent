...
JAVA_SRC_OUTPUT=java/src/com/frostwire/libtorrent/swig

rm -rf $JAVA_SRC_OUTPUT
mkdir -p $JAVA_SRC_OUTPUT

swig -c++ -java -o libtorrent_jni.cpp -outdir $JAVA_SRC_OUTPUT -package com.frostwire.libtorrent.swig \
...
CC="clang++"
INCLUDES="-I/usr/local/include -I/Library/Java/JavaVirtualMachines/jdk1.8.0_11.jdk/Contents/Home/include/ -I/Library/Java/JavaVirtualMachines/jdk1.8.0_11.jdk/Contents/Home/include/darwin"
