...
================================
To perform a local build you will need to run the build scripts in the `swig/` folder.

If you're on macos you can use the `build-macos.sh`, running it without setting things up should tell you about certain environment variables you'll need to set up. To understand the build process we recommend you read `build-utils.shinc`
