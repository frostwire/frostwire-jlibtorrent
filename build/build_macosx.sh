...
#$BOOST_ROOT/bjam toolset=darwin cxxflags="-O2" variant=release link=static deprecated-functions=off logging=none encryption=openssl boost=source

CXX=clang++
CXXFLAGS="-stdlib=libc++ -std=c++11 -O2"
DEFINES="-DNDEBUG=1 -DBOOST_ASIO_SEPARATE_COMPILATION=1 -DTORRENT_USE_ABSOLUTE_TIME=1 -DTORRENT_DISABLE_GEO_IP=1 -DTORRENT_NO_DEPRECATE=1 -DDTORRENT_USE_OPENSSL=1"
