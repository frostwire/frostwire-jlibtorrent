...
CXX=g++
DEFINES="-DNDEBUG=1 -DBOOST_NO_CXX11_NOEXCEPT -DBOOST_ASIO_SEPARATE_COMPILATION=1 -DTORRENT_USE_CLOCK_GETTIME=1 -DTORRENT_DISABLE_GEO_IP=1 -DTORRENT_NO_DEPRECATE=1"
