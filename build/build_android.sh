...
#$BOOST_ROOT/bjam toolset=gcc-arm variant=release link=static target-os=linux deprecated-functions=off logging=none encryption=openssl boost=source

CXX=arm-linux-androideabi-g++
CXXFLAGS="-mthumb -fno-strict-aliasing -lstdc++ -std=c++11 -Os -march=armv7-a -DNDEBUG -D__GLIBC__ -D_GLIBCXX__PTHREADS -D__arm__ -D_REENTRANT -fpermissive"
...
LIBS="-ltorrent -lboost_system -lboost_chrono -lboost_date_time -lboost_thread -lboost_atomic -lboost_random -lssl -lcrypto"
