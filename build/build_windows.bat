rem set CXXFLAGS=/O2 /fp:fast /DNDEBUG=1 /I"C:\boost_1_56_0"
rem bjam toolset=msvc variant=release link=static deprecated-functions=off


set LIBS=advapi32.lib
set LOPT=/RELEASE /NOLOGO /MACHINE:X86 /ENTRY:_DllMainCRTStartup@12 /DLL
set CFLAGS=/O2 /fp:fast /nologo /DWIN32 /EHsc /c /DNDEBUG=1 /DBOOST_ASIO_SEPARATE_COMPILATION=1 /DTORRENT_DISABLE_GEO_IP=1 /DTORRENT_NO_DEPRECATE=1
