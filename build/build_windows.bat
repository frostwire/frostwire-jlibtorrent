...
rem 1. Download boost_1_57_0-msvc-11.0-32.exe [http://softlayer-dal.dl.sourceforge.net/project/boost/boost-binaries/1.57.0/boost_1_57_0-msvc-11.0-32.exe]
rem 2. Extract it in "c:\boost_1_57_0"
...
rem set BOOST_ROOT=C:\boost_1_57_0
...
set BOOST_LIBPATH=%BOOST_ROOT%\lib32-msvc-11.0
