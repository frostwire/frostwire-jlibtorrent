...
public class peer_alert extends torrent_alert {
  ...
  public void setIp(SWIGTYPE_p_tcp__endpoint value) {
    libtorrent_jni.peer_alert_ip_set(swigCPtr, this, SWIGTYPE_p_tcp__endpoint.getCPtr(value));
  }

  public SWIGTYPE_p_tcp__endpoint getIp() {
    return new SWIGTYPE_p_tcp__endpoint(libtorrent_jni.peer_alert_ip_get(swigCPtr, this), true);
  }
