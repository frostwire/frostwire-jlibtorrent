...
public class lazy_entry {
  ...
  public lazy_entry list_at(int i) {
    long cPtr = libtorrent_jni.lazy_entry_list_at__SWIG_0(swigCPtr, this, i);
    return (cPtr == 0) ? null : new lazy_entry(cPtr, false);
  }
  ...
  public static int bdecode(char_vector buffer, lazy_entry ret, error_code ec) {
    return libtorrent_jni.lazy_entry_bdecode(char_vector.getCPtr(buffer), buffer, lazy_entry.getCPtr(ret), ret, error_code.getCPtr(ec), ec);
  }
