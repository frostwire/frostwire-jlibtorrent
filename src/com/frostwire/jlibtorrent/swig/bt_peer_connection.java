...
public class bt_peer_connection extends peer_connection {
  ...
  protected bt_peer_connection(long cPtr, boolean cMemoryOwn) {
    super(libtorrent_jni.bt_peer_connection_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public void write_piece(peer_request r, disk_buffer_holder buffer) {
    libtorrent_jni.bt_peer_connection_write_piece(swigCPtr, this, peer_request.getCPtr(r), r, disk_buffer_holder.getCPtr(buffer), buffer);
  }

  public void write_handshake() {
    libtorrent_jni.bt_peer_connection_write_handshake(swigCPtr, this);
  }
