...
public class peer_log_alert extends peer_alert {
  ...
  public peer_log_alert(torrent_handle h, tcp_endpoint i, sha1_hash pi, String log) {
    this(libtorrent_jni.new_peer_log_alert(torrent_handle.getCPtr(h), h, tcp_endpoint.getCPtr(i), i, sha1_hash.getCPtr(pi), pi, log), true);
  }
  ...
  public void setMsg(String value) {
    libtorrent_jni.peer_log_alert_msg_set(swigCPtr, this, value);
  }

  public String getMsg() {
    return libtorrent_jni.peer_log_alert_msg_get(swigCPtr, this);
  }
