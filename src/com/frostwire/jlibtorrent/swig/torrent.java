...
public class torrent {
  ...
  public void on_resume_data_checked(int ret, disk_io_job j) {
    libtorrent_jni.torrent_on_resume_data_checked(swigCPtr, this, ret, disk_io_job.getCPtr(j), j);
  }

  public void on_force_recheck(int ret, disk_io_job j) {
    libtorrent_jni.torrent_on_force_recheck(swigCPtr, this, ret, disk_io_job.getCPtr(j), j);
  }

  public void on_piece_checked(int ret, disk_io_job j) {
    libtorrent_jni.torrent_on_piece_checked(swigCPtr, this, ret, disk_io_job.getCPtr(j), j);
  }
  ...
  public void on_disk_write_complete(int ret, disk_io_job j, peer_request p) {
    libtorrent_jni.torrent_on_disk_write_complete(swigCPtr, this, ret, disk_io_job.getCPtr(j), j, peer_request.getCPtr(p), p);
  }

  public void on_disk_cache_complete(int ret, disk_io_job j) {
    libtorrent_jni.torrent_on_disk_cache_complete(swigCPtr, this, ret, disk_io_job.getCPtr(j), j);
  }
  ...
  public void on_disk_read_complete(int ret, disk_io_job j, peer_request r, torrent.read_piece_struct rp) {
    libtorrent_jni.torrent_on_disk_read_complete(swigCPtr, this, ret, disk_io_job.getCPtr(j), j, peer_request.getCPtr(r), r, torrent.read_piece_struct.getCPtr(rp), rp);
  }
  ...
  public storage_interface get_storage() {
    long cPtr = libtorrent_jni.torrent_get_storage(swigCPtr, this);
  ...
  public void handle_disk_error(disk_io_job j, peer_connection c) {
    libtorrent_jni.torrent_handle_disk_error__SWIG_0(swigCPtr, this, disk_io_job.getCPtr(j), j, peer_connection.getCPtr(c), c);
  }

  public void handle_disk_error(disk_io_job j) {
    libtorrent_jni.torrent_handle_disk_error__SWIG_1(swigCPtr, this, disk_io_job.getCPtr(j), j);
  }
