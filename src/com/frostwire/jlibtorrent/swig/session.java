...
public class session {
  ...
  public alert wait_for_alert(posix_time_duration max_wait) {
    long cPtr = libtorrent_jni.session_wait_for_alert(swigCPtr, this, posix_time_duration.getCPtr(max_wait), max_wait);
