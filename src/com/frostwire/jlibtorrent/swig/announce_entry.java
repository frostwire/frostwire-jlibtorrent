...
public class announce_entry {
  ...
  public boolean can_announce(SWIGTYPE_p_ptime now, boolean is_seed) {
    return libtorrent_jni.announce_entry_can_announce(swigCPtr, this, SWIGTYPE_p_ptime.getCPtr(now), is_seed);
  }
