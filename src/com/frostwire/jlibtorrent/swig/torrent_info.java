...
public class torrent_info {
  ...
  public torrent_info(String buffer, int size) {
    this(libtorrent_jni.new_torrent_info__SWIG_3(buffer, size), true);
  }

  public torrent_info(String filename) {
    this(libtorrent_jni.new_torrent_info__SWIG_5(filename), true);
  }

  public torrent_info(torrent_info t, int flags) {
    this(libtorrent_jni.new_torrent_info__SWIG_6(torrent_info.getCPtr(t), t, flags), true);
  }

  public torrent_info(torrent_info t) {
    this(libtorrent_jni.new_torrent_info__SWIG_7(torrent_info.getCPtr(t), t), true);
  }

  public torrent_info(sha1_hash info_hash, int flags) {
    this(libtorrent_jni.new_torrent_info__SWIG_8(sha1_hash.getCPtr(info_hash), info_hash, flags), true);
  }

  public torrent_info(sha1_hash info_hash) {
    this(libtorrent_jni.new_torrent_info__SWIG_9(sha1_hash.getCPtr(info_hash), info_hash), true);
  }

  public torrent_info(lazy_entry torrent_file, error_code ec, int flags) {
    this(libtorrent_jni.new_torrent_info__SWIG_10(lazy_entry.getCPtr(torrent_file), torrent_file, error_code.getCPtr(ec), ec, flags), true);
  }

  public torrent_info(lazy_entry torrent_file, error_code ec) {
    this(libtorrent_jni.new_torrent_info__SWIG_11(lazy_entry.getCPtr(torrent_file), torrent_file, error_code.getCPtr(ec), ec), true);
  }

  public torrent_info(String buffer, int size, error_code ec, int flags) {
    this(libtorrent_jni.new_torrent_info__SWIG_12(buffer, size, error_code.getCPtr(ec), ec, flags), true);
  }

  public torrent_info(String buffer, int size, error_code ec) {
    this(libtorrent_jni.new_torrent_info__SWIG_13(buffer, size, error_code.getCPtr(ec), ec), true);
  }

  public torrent_info(String filename, error_code ec, int flags) {
    this(libtorrent_jni.new_torrent_info__SWIG_14(filename, error_code.getCPtr(ec), ec, flags), true);
  }

  public torrent_info(String filename, error_code ec) {
    this(libtorrent_jni.new_torrent_info__SWIG_15(filename, error_code.getCPtr(ec), ec), true);
  }
