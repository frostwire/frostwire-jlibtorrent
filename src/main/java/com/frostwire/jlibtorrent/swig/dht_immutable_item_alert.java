...
public class dht_immutable_item_alert extends alert {
  ...
  public void setTarget(SWIGTYPE_p_sha1_hash value) {
    libtorrent_jni.dht_immutable_item_alert_target_set(swigCPtr, this, SWIGTYPE_p_sha1_hash.getCPtr(value));
  }

  public SWIGTYPE_p_sha1_hash getTarget() {
    return new SWIGTYPE_p_sha1_hash(libtorrent_jni.dht_immutable_item_alert_target_get(swigCPtr, this), true);
  }
