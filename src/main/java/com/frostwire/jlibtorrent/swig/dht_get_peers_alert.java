...
public class dht_get_peers_alert extends alert {
  ...
  public void setInfo_hash(SWIGTYPE_p_sha1_hash value) {
    libtorrent_jni.dht_get_peers_alert_info_hash_set(swigCPtr, this, SWIGTYPE_p_sha1_hash.getCPtr(value));
  }

  public SWIGTYPE_p_sha1_hash getInfo_hash() {
    return new SWIGTYPE_p_sha1_hash(libtorrent_jni.dht_get_peers_alert_info_hash_get(swigCPtr, this), true);
  }
