...
public class tracker_warning_alert extends tracker_alert {
  ...
  public void setVersion(SWIGTYPE_p_protocol_version value) {
    libtorrent_jni.tracker_warning_alert_version_set(swigCPtr, this, SWIGTYPE_p_protocol_version.getCPtr(value));
  }

  public SWIGTYPE_p_protocol_version getVersion() {
    return new SWIGTYPE_p_protocol_version(libtorrent_jni.tracker_warning_alert_version_get(swigCPtr, this), true);
  }
