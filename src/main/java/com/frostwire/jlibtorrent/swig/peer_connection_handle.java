...
public class peer_connection_handle {
  ...
  public void disconnect(error_code ec, SWIGTYPE_p_operation_t op, int arg2) {
    libtorrent_jni.peer_connection_handle_disconnect__SWIG_0(swigCPtr, this, error_code.getCPtr(ec), ec, SWIGTYPE_p_operation_t.getCPtr(op), arg2);
  }

  public void disconnect(error_code ec, SWIGTYPE_p_operation_t op) {
    libtorrent_jni.peer_connection_handle_disconnect__SWIG_1(swigCPtr, this, error_code.getCPtr(ec), ec, SWIGTYPE_p_operation_t.getCPtr(op));
  }
