...
public class state_changed_alert extends torrent_alert {
  ...
  public SWIGTYPE_p_torrent_status__state_t getState() {
    return new SWIGTYPE_p_torrent_status__state_t(libtorrent_jni.state_changed_alert_state_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_torrent_status__state_t getPrev_state() {
    return new SWIGTYPE_p_torrent_status__state_t(libtorrent_jni.state_changed_alert_prev_state_get(swigCPtr, this), true);
  }
