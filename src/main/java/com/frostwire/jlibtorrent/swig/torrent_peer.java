...
public class torrent_peer {
  ...
  public void setConnection(peer_connection_interface value) {
    libtorrent_jni.torrent_peer_connection_set(swigCPtr, this, peer_connection_interface.getCPtr(value), value);
  }

  public peer_connection_interface getConnection() {
    long cPtr = libtorrent_jni.torrent_peer_connection_get(swigCPtr, this);
    return (cPtr == 0) ? null : new peer_connection_interface(cPtr, false);
  }
