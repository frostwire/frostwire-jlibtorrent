...
public class state_update_alert extends alert {
  ...
  public void setStatus(SWIGTYPE_p_std__vectorT_torrent_status_t value) {
    libtorrent_jni.state_update_alert_status_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_torrent_status_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorT_torrent_status_t getStatus() {
    long cPtr = libtorrent_jni.state_update_alert_status_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_std__vectorT_torrent_status_t(cPtr, false);
  }
