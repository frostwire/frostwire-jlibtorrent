...
public class dht_stats_alert extends alert {
  ...
  public void setLocal_endpoint(SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t value) {
    libtorrent_jni.dht_stats_alert_local_endpoint_set(swigCPtr, this, SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t.getCPtr(value));
  }

  public SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t getLocal_endpoint() {
    long cPtr = libtorrent_jni.dht_stats_alert_local_endpoint_get(swigCPtr, this);
