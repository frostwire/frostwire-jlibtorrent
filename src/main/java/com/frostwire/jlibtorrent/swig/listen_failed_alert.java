...
public class listen_failed_alert extends alert {
  ...
  public SWIGTYPE_p_error_code getError() {
    return new SWIGTYPE_p_error_code(libtorrent_jni.listen_failed_alert_error_get(swigCPtr, this), true);
  }

  public void setOp(SWIGTYPE_p_operation_t value) {
    libtorrent_jni.listen_failed_alert_op_set(swigCPtr, this, SWIGTYPE_p_operation_t.getCPtr(value));
  }

  public SWIGTYPE_p_operation_t getOp() {
    return new SWIGTYPE_p_operation_t(libtorrent_jni.listen_failed_alert_op_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_lt__socket_type_t getSocket_type() {
    return new SWIGTYPE_p_lt__socket_type_t(libtorrent_jni.listen_failed_alert_socket_type_get(swigCPtr, this), true);
  }

  public void setAddress(SWIGTYPE_p_libtorrent__aux__noexcept_movableT_lt__address_t value) {
    libtorrent_jni.listen_failed_alert_address_set(swigCPtr, this, SWIGTYPE_p_libtorrent__aux__noexcept_movableT_lt__address_t.getCPtr(value));
  }

  public SWIGTYPE_p_libtorrent__aux__noexcept_movableT_lt__address_t getAddress() {
    return new SWIGTYPE_p_libtorrent__aux__noexcept_movableT_lt__address_t(libtorrent_jni.listen_failed_alert_address_get(swigCPtr, this), true);
  }
