...
public class torrent_handle {
  ...
  public void move_storage(String save_path, SWIGTYPE_p_move_flags_t flags) {
    libtorrent_jni.torrent_handle_move_storage__SWIG_0(swigCPtr, this, save_path, SWIGTYPE_p_move_flags_t.getCPtr(flags));
  }
