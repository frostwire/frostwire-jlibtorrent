...
public class dht_live_nodes_alert extends alert {
  ...
  public int category() {
    return libtorrent_jni.dht_live_nodes_alert_category(swigCPtr, this);
  }
  ...
  public final static int static_category = libtorrent_jni.dht_live_nodes_alert_static_category_get();
}
