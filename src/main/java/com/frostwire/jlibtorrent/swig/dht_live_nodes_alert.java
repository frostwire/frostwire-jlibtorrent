...
public class dht_live_nodes_alert extends alert {
  ...
  public SWIGTYPE_p_std__vectorT_std__pairT_libtorrent__sha1_hash_libtorrent__udp__endpoint_t_t nodes() {
    return new SWIGTYPE_p_std__vectorT_std__pairT_libtorrent__sha1_hash_libtorrent__udp__endpoint_t_t(libtorrent_jni.dht_live_nodes_alert_nodes(swigCPtr, this), true);
  }
