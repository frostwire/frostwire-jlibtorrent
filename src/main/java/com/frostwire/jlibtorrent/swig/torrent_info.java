...
public class torrent_info {
  ...
  public SWIGTYPE_p_file_storage files() {
    return new SWIGTYPE_p_file_storage(libtorrent_jni.torrent_info_files(swigCPtr, this), false);
  }

  public SWIGTYPE_p_file_storage orig_files() {
    return new SWIGTYPE_p_file_storage(libtorrent_jni.torrent_info_orig_files(swigCPtr, this), false);
  }
  ...
  public void remap_files(SWIGTYPE_p_file_storage f) {
    libtorrent_jni.torrent_info_remap_files(swigCPtr, this, SWIGTYPE_p_file_storage.getCPtr(f));
  }
  ...
  public SWIGTYPE_p_std__vectorT_file_slice_t map_block(int piece, long offset, int size) {
