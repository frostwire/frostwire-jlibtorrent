...
public class settings_pack {
  ...
  public final static class int_types {
    ...
    public final static settings_pack.int_types peer_tos = new settings_pack.int_types("peer_tos", libtorrent_jni.settings_pack_peer_tos_get());
