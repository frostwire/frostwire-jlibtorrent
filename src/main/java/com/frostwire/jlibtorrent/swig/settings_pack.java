...
public class settings_pack {
  ...
  public final static class bool_types {
    ...
    public final static settings_pack.bool_types incoming_socks5_connections = new settings_pack.bool_types("incoming_socks5_connections");
