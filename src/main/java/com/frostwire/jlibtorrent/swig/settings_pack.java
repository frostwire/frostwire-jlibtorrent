...
public class settings_pack {
  ...
  public final static class bool_types {
    ...
    public final static settings_pack.bool_types deprecated24 = new settings_pack.bool_types("deprecated24");
