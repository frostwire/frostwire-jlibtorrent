...
public class dht_direct_response_alert extends alert {
  ...
  public void setUserdata(SWIGTYPE_p_libtorrent__client_data_t value) {
    libtorrent_jni.dht_direct_response_alert_userdata_set(swigCPtr, this, SWIGTYPE_p_libtorrent__client_data_t.getCPtr(value));
  }

  public SWIGTYPE_p_libtorrent__client_data_t getUserdata() {
    long cPtr = libtorrent_jni.dht_direct_response_alert_userdata_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_libtorrent__client_data_t(cPtr, false);
  }

  public void setEndpoint(SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t value) {
    libtorrent_jni.dht_direct_response_alert_endpoint_set(swigCPtr, this, SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t.getCPtr(value));
  }

  public SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t getEndpoint() {
    long cPtr = libtorrent_jni.dht_direct_response_alert_endpoint_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t(cPtr, false);
  }

  public SWIGTYPE_p_bdecode_node response() {
    return new SWIGTYPE_p_bdecode_node(libtorrent_jni.dht_direct_response_alert_response(swigCPtr, this), true);
  }
