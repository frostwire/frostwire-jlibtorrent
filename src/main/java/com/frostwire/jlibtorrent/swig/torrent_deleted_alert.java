...
public class torrent_deleted_alert extends torrent_alert {
  ...
  public void setInfo_hashes(SWIGTYPE_p_info_hash_t value) {
    libtorrent_jni.torrent_deleted_alert_info_hashes_set(swigCPtr, this, SWIGTYPE_p_info_hash_t.getCPtr(value));
  }

  public SWIGTYPE_p_info_hash_t getInfo_hashes() {
    return new SWIGTYPE_p_info_hash_t(libtorrent_jni.torrent_deleted_alert_info_hashes_get(swigCPtr, this), true);
  }
