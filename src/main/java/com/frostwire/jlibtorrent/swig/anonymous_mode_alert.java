...
public class anonymous_mode_alert extends torrent_alert {
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.anonymous_mode_alert_category(swigCPtr, this), true);
  }
  ...
  public final static alert_category_t static_category = new alert_category_t(libtorrent_jni.anonymous_mode_alert_static_category_get(), false);
