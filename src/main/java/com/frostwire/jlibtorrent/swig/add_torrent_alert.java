...
public class add_torrent_alert extends torrent_alert {
  ...
  public void setParams(SWIGTYPE_p_add_torrent_params value) {
    libtorrent_jni.add_torrent_alert_params_set(swigCPtr, this, SWIGTYPE_p_add_torrent_params.getCPtr(value));
  }

  public SWIGTYPE_p_add_torrent_params getParams() {
    return new SWIGTYPE_p_add_torrent_params(libtorrent_jni.add_torrent_alert_params_get(swigCPtr, this), true);
  }

  public void setError(SWIGTYPE_p_error_code value) {
    libtorrent_jni.add_torrent_alert_error_set(swigCPtr, this, SWIGTYPE_p_error_code.getCPtr(value));
  }

  public SWIGTYPE_p_error_code getError() {
    return new SWIGTYPE_p_error_code(libtorrent_jni.add_torrent_alert_error_get(swigCPtr, this), true);
  }
