...
public class dht_error_alert extends alert {
  ...
  public void setError(SWIGTYPE_p_error_code value) {
    libtorrent_jni.dht_error_alert_error_set(swigCPtr, this, SWIGTYPE_p_error_code.getCPtr(value));
  }

  public SWIGTYPE_p_error_code getError() {
    return new SWIGTYPE_p_error_code(libtorrent_jni.dht_error_alert_error_get(swigCPtr, this), true);
  }
