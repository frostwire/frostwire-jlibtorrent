...
public class create_torrent {
  ...
  public create_torrent(SWIGTYPE_p_file_storage fs, int piece_size, create_flags_t flags) {
    this(libtorrent_jni.new_create_torrent__SWIG_0(SWIGTYPE_p_file_storage.getCPtr(fs), piece_size, create_flags_t.getCPtr(flags), flags), true);
  }

  public create_torrent(SWIGTYPE_p_file_storage fs, int piece_size) {
    this(libtorrent_jni.new_create_torrent__SWIG_1(SWIGTYPE_p_file_storage.getCPtr(fs), piece_size), true);
  }

  public create_torrent(SWIGTYPE_p_file_storage fs) {
    this(libtorrent_jni.new_create_torrent__SWIG_2(SWIGTYPE_p_file_storage.getCPtr(fs)), true);
  }
  ...
  public SWIGTYPE_p_file_storage files() {
    return new SWIGTYPE_p_file_storage(libtorrent_jni.create_torrent_files(swigCPtr, this), false);
  }
  ...
  public void add_http_seed(string_view url) {
    libtorrent_jni.create_torrent_add_http_seed__SWIG_0(swigCPtr, this, string_view.getCPtr(url), url);
  }
