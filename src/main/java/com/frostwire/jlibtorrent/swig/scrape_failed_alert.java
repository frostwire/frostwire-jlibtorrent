...
public class scrape_failed_alert extends tracker_alert {
  ...
  public void setVersion(protocol_version value) {
    libtorrent_jni.scrape_failed_alert_version_set(swigCPtr, this, value.swigValue());
  }

  public protocol_version getVersion() {
    return protocol_version.swigToEnum(libtorrent_jni.scrape_failed_alert_version_get(swigCPtr, this));
  }
