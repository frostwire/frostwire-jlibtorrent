...
public class udp_error_alert extends alert {
  ...
  public void setEndpoint(SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t value) {
    libtorrent_jni.udp_error_alert_endpoint_set(swigCPtr, this, SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t.getCPtr(value));
  }
  ...
  public void setOperation(SWIGTYPE_p_operation_t value) {
    libtorrent_jni.udp_error_alert_operation_set(swigCPtr, this, SWIGTYPE_p_operation_t.getCPtr(value));
  }

  public SWIGTYPE_p_operation_t getOperation() {
    return new SWIGTYPE_p_operation_t(libtorrent_jni.udp_error_alert_operation_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_error_code getError() {
    return new SWIGTYPE_p_error_code(libtorrent_jni.udp_error_alert_error_get(swigCPtr, this), true);
  }
