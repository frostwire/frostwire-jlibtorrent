...
public class file_storage {
  ...
  public SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t file_flags(int index) {
    return new SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t(libtorrent_jni.file_storage_file_flags(swigCPtr, this, index), true);
  }
  ...
  public void add_file_ex(error_code ec, String path, long file_size, SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t file_flags, long mtime, String symlink_path) {
    libtorrent_jni.file_storage_add_file_ex__SWIG_0(swigCPtr, this, error_code.getCPtr(ec), ec, path, file_size, SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t.getCPtr(file_flags), mtime, symlink_path);
  }

  public void add_file_ex(error_code ec, String path, long file_size, SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t file_flags, long mtime) {
    libtorrent_jni.file_storage_add_file_ex__SWIG_1(swigCPtr, this, error_code.getCPtr(ec), ec, path, file_size, SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t.getCPtr(file_flags), mtime);
  }

  public void add_file_ex(error_code ec, String path, long file_size, SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t file_flags) {
    libtorrent_jni.file_storage_add_file_ex__SWIG_2(swigCPtr, this, error_code.getCPtr(ec), ec, path, file_size, SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t.getCPtr(file_flags));
  }
  ...
  public final static SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t flag_pad_file = new SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t(libtorrent_jni.file_storage_flag_pad_file_get(), false);
  public final static SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t flag_hidden = new SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t(libtorrent_jni.file_storage_flag_hidden_get(), false);
  public final static SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t flag_executable = new SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t(libtorrent_jni.file_storage_flag_executable_get(), false);
  public final static SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t flag_symlink = new SWIGTYPE_p_flags__bitfield_flagT_std__uint8_t_libtorrent__file_flags_tag_t(libtorrent_jni.file_storage_flag_symlink_get(), false);
}
