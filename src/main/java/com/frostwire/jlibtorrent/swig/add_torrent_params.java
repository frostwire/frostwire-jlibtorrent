...
public class add_torrent_params {
  ...
  public void setStorage_mode(SWIGTYPE_p_storage_mode_t value) {
    libtorrent_jni.add_torrent_params_storage_mode_set(swigCPtr, this, SWIGTYPE_p_storage_mode_t.getCPtr(value));
  }

  public SWIGTYPE_p_storage_mode_t getStorage_mode() {
    return new SWIGTYPE_p_storage_mode_t(libtorrent_jni.add_torrent_params_storage_mode_get(swigCPtr, this), true);
  }
