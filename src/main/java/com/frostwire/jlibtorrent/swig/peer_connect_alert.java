...
public class peer_connect_alert extends peer_alert {
  ...
  public void setSocket_type(SWIGTYPE_p_socket_type_t value) {
    libtorrent_jni.peer_connect_alert_socket_type_set(swigCPtr, this, SWIGTYPE_p_socket_type_t.getCPtr(value));
  }

  public SWIGTYPE_p_socket_type_t getSocket_type() {
    return new SWIGTYPE_p_socket_type_t(libtorrent_jni.peer_connect_alert_socket_type_get(swigCPtr, this), true);
  }
