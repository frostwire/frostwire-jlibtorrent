...
public class peer_disconnected_alert extends peer_alert {
  ...
  public SWIGTYPE_p_socket_type_t getSocket_type() {
    return new SWIGTYPE_p_socket_type_t(libtorrent_jni.peer_disconnected_alert_socket_type_get(swigCPtr, this), true);
  }
  ...
  public SWIGTYPE_p_error_code getError() {
    return new SWIGTYPE_p_error_code(libtorrent_jni.peer_disconnected_alert_error_get(swigCPtr, this), true);
  }

  public SWIGTYPE_p_close_reason_t getReason() {
    return new SWIGTYPE_p_close_reason_t(libtorrent_jni.peer_disconnected_alert_reason_get(swigCPtr, this), true);
  }
