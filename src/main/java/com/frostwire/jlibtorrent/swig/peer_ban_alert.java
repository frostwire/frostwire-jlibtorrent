...
public class peer_ban_alert extends peer_alert {
  ...
  public peer_ban_alert(stack_allocator alloc, torrent_handle h, tcp_endpoint ep, sha1_hash peer_id) {
    this(libtorrent_jni.new_peer_ban_alert(stack_allocator.getCPtr(alloc), alloc, torrent_handle.getCPtr(h), h, tcp_endpoint.getCPtr(ep), ep, sha1_hash.getCPtr(peer_id), peer_id), true);
  }
