...
public class portmap_alert extends alert {
  ...
  public void setLocal_address(SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__address_t value) {
    libtorrent_jni.portmap_alert_local_address_set(swigCPtr, this, SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__address_t.getCPtr(value));
  }

  public SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__address_t getLocal_address() {
    long cPtr = libtorrent_jni.portmap_alert_local_address_get(swigCPtr, this);
