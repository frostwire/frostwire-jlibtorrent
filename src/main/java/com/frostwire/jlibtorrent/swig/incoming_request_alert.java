...
public class incoming_request_alert extends peer_alert {
  ...
  public void setReq(SWIGTYPE_p_peer_request value) {
    libtorrent_jni.incoming_request_alert_req_set(swigCPtr, this, SWIGTYPE_p_peer_request.getCPtr(value));
  }

  public SWIGTYPE_p_peer_request getReq() {
    return new SWIGTYPE_p_peer_request(libtorrent_jni.incoming_request_alert_req_get(swigCPtr, this), true);
  }
