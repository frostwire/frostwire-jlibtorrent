...
public class dht_outgoing_get_peers_alert extends alert {
  ...
  public void setEndpoint(SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t value) {
    libtorrent_jni.dht_outgoing_get_peers_alert_endpoint_set(swigCPtr, this, SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t.getCPtr(value));
  }

  public SWIGTYPE_p_libtorrent__aux__noexcept_movableT_libtorrent__udp__endpoint_t getEndpoint() {
    long cPtr = libtorrent_jni.dht_outgoing_get_peers_alert_endpoint_get(swigCPtr, this);
